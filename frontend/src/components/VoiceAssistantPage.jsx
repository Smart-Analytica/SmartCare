...
const VoiceAssistantPage = () => {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('.aws-ai-button').forEach((btn) => {
      btn.parentNode?.removeChild(btn);
    });

    // Remove existing script (if any)
    const existingScript = document.querySelector(
      'script[src="https://cdn.jsdelivr.net/gh/awsAI/html-script-tag@latest/dist/assets/index.js"]'
    );
    if (existingScript) {
    ...
    script.onload = () => {
      if (window.awsSDK && buttonContainerRef.current) {
        window.awsSDK.run({
          apiKey,
	assistant: assistantId,
        ...
        const observer = new MutationObserver(() => {
          const button = document.querySelector('.aws-ai-button');
          if (button) {
